...
import { Animation, Node, Mesh, Vector3, VRExperienceHelper, Scene, MeshBuilder, StandardMaterial, Texture, TransformNode, OculusTouchController } from "@babylonjs/core";
...
export class Canvas {
    ...
    constructor(scene: Scene, vrHelper: VRExperienceHelper, toolPalette: ToolPalette) {
